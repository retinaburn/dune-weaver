...
AccelStepper inOutStepper(AccelStepper::FULL4WIRE, ROT_PIN1, ROT_PIN3, ROT_PIN2, ROT_PIN4); // In-out axis
...
void connect(){
  ...
  Serial.println(client.sessionPresent());
}
...
void messageReceivedBytes(MQTTClient *client, char topic[], char bytes[], int length){
  //String message = "Bytes received" + length;
  //Serial.println(message);
  Serial.print("Received data: ");
  Serial.println(length);
  Serial.print(bytes);
  // Serial.print("Dropped messages: ");
  // Serial.println(client->droppedMessages());
}
